...
.n-file-name { font-size: 13px; font-weight: 600; color: var(--n-ink); line-height: 1.2; }
...
.n-file-status { font-size: 11px; font-weight: 600; flex-shrink: 0; text-align: right; }
.n-file-status.loaded { color: var(--n-good); }
.n-file-status.missing { color: #CFCBDB; }

/* ═══ PROGRESS ═══ */
.n-progress-block { margin: 20px 0 0; }
...
.n-stages { display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; position: relative; }
...
.n-stage-col { display: flex; flex-direction: column; align-items: center; gap: 10px; position: relative; z-index: 1; }
...
.n-stage-label { font-size: 12px; font-weight: 600; color: var(--n-ink-faint); text-align: center; transition: color 0.3s; }
...
/* ═══ OUTPUT RESULTS ═══ */
.n-results { background: var(--n-panel); border: 1px solid var(--n-line); border-radius: 14px; padding: 24px 28px; box-shadow: 0 1px 2px rgba(32,28,44,0.03); }
.n-results-title { font-family: 'Fraunces', serif; font-size: 13px; font-style: italic; font-weight: 500; color: var(--n-ink-soft); margin-bottom: 18px; }
.n-result-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 12px; margin-bottom: 20px; }

.n-result-card { border-radius: 10px; padding: 14px 16px; border: 1px solid var(--n-line-soft); background: #FCFBFA; }
...
.n-rc-name { font-size: 10px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--n-ink-faint); margin-bottom: 6px; }
.n-rc-stat { font-size: 20px; font-weight: 800; line-height: 1; margin-bottom: 5px; }
