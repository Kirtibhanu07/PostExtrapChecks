...
[data-testid="stFileUploaderDropzone"]:hover { border-color: var(--n-violet) !important; background: var(--n-violet-wash) !important; }

[data-testid="stFileUploaderDropzoneInstructions"] svg { display: none; }
[data-testid="stFileUploaderDropzoneInstructions"] { color: var(--n-ink-faint) !important; font-size: 10.5px !important; }
[data-testid="stFileUploaderDropzoneInstructions"] > div > small { color: #C9C4DB !important; font-size: 9.5px !important; }
[data-testid="stFileUploaderFileName"] { color: var(--n-ink) !important; font-size: 10.5px !important; font-weight: 500 !important; }
[data-testid="stBaseButton-secondary"] { transform: scale(0.85); }
...
st.markdown('<div class="n-shell">', unsafe_allow_html=True)

# ═══════════════════════════════════════════════════════════════════════════
# STEP 1 — SOURCE FILES
# ═══════════════════════════════════════════════════════════════════════════
st.markdown('<div class="n-section">', unsafe_allow_html=True)
st.markdown("""
...
for col, (key, label, hint) in zip(upload_cols, FILE_DEFS):
    with col:
        ...
        st.markdown(f'<div class="n-upload-card{" is-loaded" if loaded_now else ""}">', unsafe_allow_html=True)
        st.markdown(f"""
        ...
        st.markdown(f'<div class="n-upload-status{" loaded" if uf else ""}">{status_txt}</div>', unsafe_allow_html=True)
...
st.markdown('<div class="n-action-row">', unsafe_allow_html=True)
...
st.markdown('</div>', unsafe_allow_html=True)  # end n-section (step 1)
...
""", unsafe_allow_html=True)
st.markdown('</div>', unsafe_allow_html=True)  # end n-section (step 2)
...
with head_col1:
    ...
    """, unsafe_allow_html=True)
with head_col2:
    st.markdown('<div class="n-toggle-wrap" style="display:flex; justify-content:flex-end;">', unsafe_allow_html=True)
...
st.markdown('</div>', unsafe_allow_html=True)  # end n-section (step 3)
...
if st.session_state.result_stats:
    ...
    st.markdown(f'<div class="n-result-grid">{cards_html}</div>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)  # end n-section (step 4)

st.markdown('</div>', unsafe_allow_html=True)  # end n-shell
