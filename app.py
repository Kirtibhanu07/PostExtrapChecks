...
# ═══════════════════════════════════════════════════════════════════════════
# Run the pipeline now, if the button was clicked. This is the same
# proven pattern used throughout every prior working version of this
# app: run_pipeline() only mutates session_state, does no rendering of
# its own, and a single st.rerun() afterward shows the complete final
# state in one pass — the three placeholders below exist so the banner,
# stage stepper, and log always land in the correct position on the
# page (Step 2/3, above the topbar) regardless of what triggered this
# script run, not to be written into mid-execution.
# ═══════════════════════════════════════════════════════════════════════════
if run_clicked:
